  ...
  return (
    <div className={styles.page}>
      <main className={styles.main}>
        ...
        <h2>Everything below is within a noscript tag</h2>
        <noscript>
